      ...
      <div class="row" style="height: calc(100vh - 200px)">
        ...
        <div class="col-10 col-md-9 col-sm-8 col-xs-12" v-if="!showFileEditor && !showFilePreview">
          ...
          <div class="row" style="height: 5vh; min-height: 40px">
            <div class="col-12">
              <q-btn-group flat>
                <q-btn flat @click="$emit('close')" icon="fas fa-arrow-left"></q-btn>
                ...
                <q-btn :disable="this.fileList.filter(e => !!e.selected).length === 0" @click="deleteSelectedFiles" flat
                       size="md" class="float-right" color="negative"
        ...
        <div class="col-10 col-md-9 col-sm-8 col-xs-12" v-if="showFileEditor">
          <div class="row">
            <div class="col-12">
              <q-btn flat @click="(showFileEditor = false ) && (fileType = null)"
        ...
        <div class="col-10 col-md-9 col-sm-8 col-xs-12" v-if="showFilePreview">
          ...
          <q-page-sticky position="bottom-right" :offset="[20, 20]">
            <q-btn flat @click="(showFilePreview = false ) && (fileType = null)"
                   icon="fas fa-long-arrow-alt-left"></q-btn>
          </q-page-sticky>
        </div>
    ...
    loadFilePathDataForTree(node, handleAsyncLoad) {
      ...
      return new Promise(function (resolve, reject) {
        that.getContentOnPath(path).then(function (files) {
          ...
          console.log("handle async load", that.asyncFileData, that.$refs.tree, files)
          handleAsyncLoad(files)
        }).catch(reject)
      })
    },
    loadDependencies() {
